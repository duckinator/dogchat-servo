...
use servo::compositing::windowing::{WindowEvent, WindowMethods, EmbedderCoordinates};
...
*/
    fn set_animation_state(&self, _id: BrowserId) {}
    fn get_coordinates(&self) -> EmbedderCoordinates { (0, 0) }
}
